diff --git a/api/translate.js b/api/translate.js
index 3dd728c5049d66b0d4f5a3731761e82aa844fa24..b50fdf5b49bd46de1cb34072d12a04b46b8fb54a 100644
--- a/api/translate.js
+++ b/api/translate.js
@@ -1,70 +1,69 @@
...
+    if (!DEEPL_API_KEY) {
+        return res.status(500).json({ 
+            error: 'DeepL API 키가 설정되지 않았습니다. 서버리스 환경변수를 확인하세요.' 
+        });
+    }
